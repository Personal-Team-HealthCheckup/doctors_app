...
class VideoPlayerWithMediaControls extends React.Component<
  VideoPlayerWithMediaControlsProps,
  VideoPlayerWithMediaControlsState
> {
  durations = [
    [10, 20],
    [20, 30],
            ...
            <>
              ...
              >
                <Video
                  ...
                  paused={
                    this.state.previewPlayerState == PLAYER_STATES.ENDED ||
                    this.state.previewPlayerState == PLAYER_STATES.PAUSED
                  }
                  style={{
                    position: 'absolute',
                    top: 0,
                ...
                {this.state.isAdsOpen && (
                  <>
                    <Video
                      testID="video-ads"
                      source={{ uri: this.state.videoAdUrl }} // Can be a URL or a local file.
                    ...
                    >
                      ...
                      >
                        <Text style={{ color: 'white' }}>
                          {moment(this.state.adsCurrentTime * 1000).format(
                            'mm:ss',
                          )}
                        </Text>
                      </View>
                      {this.state.isAdsSkipable &&
                      this.state.adsCurrentTime >
                        Number(this.state.skippableTime) ? (
                        <TouchableOpacity
                          testID="btn-skip-ads"
              ...
              >
                <Video
                  ...
                  paused={
                    ...
                    this.state.playerState == PLAYER_STATES.PAUSED
                  }
              ...
              {this.state.isEnableAds && (
                <>
                  ...
                  <Text style={{ textAlign: 'center', marginTop: 16 }}>
                    Select timestamp that you want to place the Ads by dragging
                    video player
                  </Text>
                  <Text
                    style={{ textAlign: 'center', marginTop: 8 }}
                  >{`Ads will be placed at ${moment(this.state.currentTime * 1000).format('mm:ss')}`}</Text>
